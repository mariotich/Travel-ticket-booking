...
<a href=""><button class="btn text-primary"><i class="fa fa-arrow-right"></i> Login</button></a>
    ...
    <div class="container-fluid">
        <div class="row row_white">
            <div class="col-md-4 " style="mt-10px" >
                <div class="media">
                    <div class="media-body">
                        <h3>Filter Buses</h3>
                    </div>
                    <img src="images/bus-sketch.png" class="align-self-center mr-3" style="width:200px">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-3">
                        <label for="#leaving_from"> Leaving From</label><br>
                        <select class="form-control" name="from" id="leaving_from">
                        ...
                        <div class="col-md-3">
                                <label for="#leaving_To"> Leaving To</label><br>
                                <select class="form-control" name="from" id="leaving_to">
                        ...
                        <div class="col-md-3">
                            <label for="#traveldate">Traveling on</label><br>
                            <input style="" class="form-control" type="datetime-local" name="traveling_on" id="traveldate">
                            
                        </div>
                        <div class="col-md-3">
                            <a href=""><input style="margin-top: 30px;;" type="btn" name="filter_btn" value="Filter"></a>
                        </div>
    ...
    <!---->
    <div class="container">
        <h4>Select bus by choosing on the prices</h4>
        <table class=" table table-dark table-bordered">
            <tr>
                <th>Normal bus <br> <h6>Kitale to Kapenguria <br> Departure time:7:30pm <br>Available seats:50</h6> </th>
                <a href=""><td>Select VIP <br> <h4>Ksh. 5000</h4></td></a>
                <a href=""><td>Select First class <br> <h4>Ksh. 4500</h4></td></a>
                <a href=""><td>Select Business class <br> <h4>Ksh. 3000</h4></td></a>
            </tr>
            <tr>
                <th>Normal bus <br> <h6>Kitale to Kapenguria <br> Departure time:7:30pm <br>Available seats:50</h6> </th>
                <td onclick="location.href='bus_seats.php'">Select VIP <br> <h4>Ksh. 5000</h4></td></a>
                <td onclick="location.href='bus_seats.php'">Select First class <br> <h4>Ksh. 4500</h4></td></a>
                <td onclick="location.href='bus_seats.php'">Select Business class <br> <h4>Ksh. 3000</h4></td></a>
            </tr>
            <tr>
                <th>Normal bus <br> <h6>Kitale to Kapenguria <br> Departure time:7:30pm <br>Available seats:50</h6> </th>
                <a href=""><td>Select VIP <br> <h4>Ksh. 5000</h4></td></a>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-4">
            <a href=""><p>Privacy Policy</p></a> <a href=""><p>Terms & conditions</p></a>
        </div>
        <div class="col-md-4"></div>
        <div class="col-md-4">
           <li class="fa fa-copyright">Copyright 2022 W.Travel|All rights Reserved</li> 
        </div>
    </div>
</div>
</footer>
