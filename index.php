...
<a href=""><button class="btn text-primary"><i class="fa fa-home"></i> Home</button></a>
    ...
    <div class="input-group mb-3">
      ...
      <select name="to" id="from" class="form-control">
        ...
        <form>
            ...
            <a href=""><input type="button" id="bus_id" value="search for available buses"></a>
        </div>
  </div>
...
<div class=container-fluid>
    <h2 style="margin-top:25px;">Services we offer</h2>
    <div class="row">
        <div class="col-md-4 " id="s1">
            <h4>Passanger Travel services</h4>
